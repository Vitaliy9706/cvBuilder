                    ...
                    <?php
                        if(isset($_GET['error'])){
                            ...
                            if($_GET['error'] == 'emptyName'){
                                ...
                                ?>
                                    <small class="form-text text-danger">Oops... Looks like this user Email already exist, try to <a href="login.php">login</a></small>
                                <?php
                            ...
                            if($_GET['success'] == 'userCreated'){
                                ?>
                                <small class="form-text text-success">User has been created successfully!</small>
                            <?php
                            }
                        }
                    ?>
